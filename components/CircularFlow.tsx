...
const stages: Stage[] = [
  {
    ...
    desc: "Source collection from communities & campuses.",
    top: "54px",
    left: "472px",
  },
  {
    id: "02",
    title: "Segregation",
    desc: "Sorting organic waste & recyclables.",
    top: "177px",
    left: "654px",
  },
  {
    id: "03",
    title: "Processing",
    desc: "Accelerated decomposition prep.",
    top: "376px",
    left: "689px",
  },
  {
    id: "04",
    title: "Composting",
    desc: "Aerobic composting process.",
    top: "554px",
    left: "560px",
  },
  {
    id: "05",
    title: "Healthy Soil",
    desc: "Refining nutrient-rich compost.",
    top: "554px",
    left: "290px",
  },
  {
    ...
    desc: "Lowering methane & landfill waste.",
    top: "376px",
    left: "161px",
  },
  {
    id: "07",
    title: "Back to waste",
    desc: "Closing the circular loop.",
    top: "129px",
    left: "234px",
  },
];
      ...
      <div className="max-w-[1320px] mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="flex flex-col items-center text-center space-y-3 max-w-[680px] mx-auto mb-4 sm:mb-6">
          ...
          <h2 className="font-farro leading-[1.08] tracking-tight text-[#2a2d2a]">
            <span className="block text-3xl sm:text-5xl md:text-[54px] font-bold">
              A Closed Loop That Turns
            </span>
            <span className="block text-3xl sm:text-5xl md:text-[54px] font-normal">
              Endings Into Beginnings.
            </span>
          </h2>
          {/* Subtitle */}
          <p className="text-xs sm:text-sm text-neutral-500 leading-relaxed font-satoshi max-w-[520px] pt-1 px-2">
            Hover any stage to see how it feeds the next. Every step is instrumented, measured and optimised.
          </p>
        </div>

        {/* Circular Loop Section Layout — Centered & Responsive Orbit Diagram for Mobile, Tablet & Desktop */}
        <div className="w-full flex items-center justify-center py-2 overflow-visible -mt-6 sm:-mt-10 md:-mt-18 lg:-mt-18">
          <div className="w-[850px] h-[640px] relative select-none scale-[0.45] min-[400px]:scale-[0.52] sm:scale-[0.72] md:scale-[0.86] lg:scale-100 origin-top shrink-0 transition-transform duration-300 -mb-[330px] min-[400px]:-mb-[290px] sm:-mb-[170px] md:-mb-[80px] lg:mb-0">
            {/* Concentric Rings */}
            <div className="w-[160px] h-[160px] top-[240px] left-[345px] border border-neutral-500/40 rounded-full absolute pointer-events-none" />
            <div className="w-[280px] h-[280px] top-[180px] left-[285px] border border-neutral-500/40 rounded-full absolute pointer-events-none" />
            <div className="w-[400px] h-[400px] top-[120px] left-[225px] border border-neutral-500/40 rounded-full absolute pointer-events-none" />
            <div className="w-[520px] h-[520px] top-[60px] left-[165px] border border-neutral-500/40 rounded-full absolute pointer-events-none" />
            <div className="w-[640px] h-[640px] top-[0px] left-[105px] border border-neutral-500/40 rounded-full absolute pointer-events-none" />
            <div className="w-[760px] h-[760px] top-[-60px] left-[45px] border border-neutral-500/40 rounded-full absolute pointer-events-none" />
            {/* <div className="w-[880px] h-[880px] top-[-120px] left-[-15px] border border-neutral-500/40 rounded-full absolute pointer-events-none" /> */}
            ...
            {stages.map((stage, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`flex items-center gap-3 backdrop-blur-md border rounded-full p-2 pr-4 shadow-[0_4px_15px_rgba(0,0,0,0.04)] cursor-pointer select-none transition-all duration-300 ${isHovered
                  ...
                  >
                    {/* Number Badge */}
                    <div
                      className={`rounded-full h-8 px-2.5 flex items-center justify-center text-xs font-bold font-farro border transition-all duration-300 ${isHovered
